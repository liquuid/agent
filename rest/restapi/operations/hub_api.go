...
// NewHubAPI creates a new Hub instance
func NewHubAPI(spec *loads.Document) *HubAPI {
	return &HubAPI{
...
/*HubAPI Subutai Agent private REST API */
type HubAPI struct {
	spec            *loads.Document
...
func (o *HubAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *HubAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *HubAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *HubAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *HubAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *HubAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *HubAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the HubAPI
func (o *HubAPI) Validate() error {
...
func (o *HubAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *HubAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *HubAPI) Authorizer() runtime.Authorizer {
...
func (o *HubAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *HubAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *HubAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the hub API
func (o *HubAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *HubAPI) initHandlerCache() {
...
func (o *HubAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
