...
func (o *ImportURL) Build() (*url.URL, error) {
	...
	if container != "" {
		...
		return nil, errors.New("Container is required on ImportURL")
	}
...
func (o *ImportURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ImportURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ImportURL")
	}
